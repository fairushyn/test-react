...
function JudgementPost({ slide, font,currentTab }) {
    ...
    return (
        <div className="postBody">
            <div className="postBodyNav">
                ...
                <h6 onClick={handleLaws} style={chooseTabStyle(2)}>LAWS</h6>
                <h6 onClick={handleRatio} style={chooseTabStyle(3)}>RATIO</h6>
                <h6>
