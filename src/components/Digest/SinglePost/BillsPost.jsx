...
function BillsPost({ slide, font, currentTab }) {
    ...
    return (
        <div className="postBody">
            <div className="postBodyNav">
                ...
                <h6 onClick={handleFeatures} style={chooseTabStyle(2)}>FEATURES</h6>
                <h6 onClick={handleDialogues} style={chooseTabStyle(3)}>DIALOGUES</h6>
                <h6>
